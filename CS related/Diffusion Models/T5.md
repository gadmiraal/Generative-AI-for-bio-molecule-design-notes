## Architecture
Text-to-Text Transfer Transformer (T5) was created to explore the transfer learning landscape for NLP. It is based on the vanilla transformer encoder-decoder with some slight modifications
